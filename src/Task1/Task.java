...
//
//        List<String> carType1 = new ArrayList<>();
...
//        typeCar(carType4);
//
//        System.out.println(" max gsm = " + getGsmMax(carType1));
//
//    }
//
//    private static int getSum(List<String> carType) {
//
...
//        return sum;
//    }
//    private static String getGsmMax(List<String> carType) {
//
//
//            getGsmCoast();
//
//
//        return Collections.max(carType);
//    }
//
...
//                        getGsmCoast();
//                    } else if ( type.contains("C200"))
//                    {
//                        fuelCost = 48.90;
//                        fuelConsumption = 12;
//                        carName = "truck";
//                        getGsmCoast();
//                    } else if (type.contains("C300"))
//                    {
//                        fuelCost = 47.50;
//                        fuelConsumption = 11.5;
//                        carName = "passenger transport";
//                        getGsmCoast();
//                    } else if ( type.contains("C400"))
//                {
//                        fuelCost = 48.90;
//                        fuelConsumption = 20;
...
//                + " - расход топлива: " + fuelConsumption + "," + " стоимость топлива: " + fuelCost +  " кол-во машин "
//        + getSum(type));
//
//    }
//
//    private static double getGsmCoast() {
